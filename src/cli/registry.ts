...
export const PLAYBOOKS: readonly PlaybookEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'It stays attached until you stop it, printing ONE JSON envelope per',
      'line (NDJSON) as each interaction is queued -- review, verification',
      'or requested change alike. It is silent while idle, so no output',
      'means nothing is waiting, never that the connection dropped.',
